...
def start_scraping():
    ...
    try:
        ...
        locations = data.get('locations', [
            ...
            'Tokyo, Japan', 'Sydney, Australia', 'Berlin, Germany', 'Toronto, Canada'
        ])
...
def get_stats():
    ...
    try:
        ...
        formatted_stats = {
            ...
            "currentMilestone": min(5, stats.get('totalProfiles', 0) // 5000 + 1),
            "profilesInCurrentMilestone": stats.get('totalProfiles', 0) % 5000,
